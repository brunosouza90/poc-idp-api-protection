...
/**
* Class responsible for converting the token generated by Keycloak
 *in order to assign the authorities the way spring security
* uses.
 */
@Component
...
public class KeycloakJwtAuthenticationConverter implements Converter<Jwt, AbstractAuthenticationToken> {
    ...
    /**
     * extract orquestration of the authorities
     * @param jwt
     * @return Collection<GrantedAuthority> has roles and scopes of the jwt
     */
    ...
    /**
     * find roles and access the realm
     * @param jwt
     * @return a collection with the roles
     */
    ...
    /**
     * Find the roles and access someone resource
     * @param jwt
     * @return a collection with the roles
     */
